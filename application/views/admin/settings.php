...
<body>
    <div class="layout-wrapper layout-content-navbar">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card mb-4">
                                    ...
                                    <div class="card-body">
                                        <form action="<?=base_url().'admin/setupweb'?>" method="POST" enctype="multipart/form-data">
                                            <div class="mb-2">
                                                <label class="form-label">Web Name</label>
                                                <input type="text" class="form-control" placeholder="Webname" name="web_name" value="<?=$web_name?>" id="webname"/>
                                                <div class="form-text">
                                                    We'll never share your details with anyone else.
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Web Logo</label><br>
                                                <img src="<?=base_url().'assets/img/website/'.$web_logo?>" width="300px">
                                                <br>
                                                <input class="form-control" name="web_logo" type="file" id="webLogo" multiple="">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label">Web Icon</label><br>
                                                <img src="<?=base_url().'assets/img/website/'.$web_icon?>" width="300px">
                                                <br>
                                                <input class="form-control" name="web_icon" type="file" id="webIcon" multiple="">
                                            </div>
                                            <div class="mb-4">
                                                <label class="form-label">Web WA Admin</label>
                                                <select id="selectpickerBasic" class="selectpicker w-100" name="web_wa_admin" data-style="btn-default">
                                                    <?php foreach($server->result() as $s): ?>
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <button type="button" name="btn-scan" id="btn-scan" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#largeModal">Scan QR
        ...
        <div id="deviceid" data="<?=$web_wa_id?>"></div>
    </div>
